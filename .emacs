...
;; Version: 0.0
;; Package-Requires: ()
;; Last-Updated: Thu Aug 16 20:08:34 2018 (+0100)
;;           By: Paul Bartholomew
;;     Update #: 61
;; URL:
;; Doc URL:
...
(require 'my_lisp)    ; lisp configuration file
...
(custom-set-variables
 ...
 '(package-selected-packages
	 (quote
		(geiser interleave paredit company-bibtex writegood-mode spacemacs-theme solarized-theme slime-company rainbow-delimiters pallet magit helm flycheck-pos-tip evil diff-hl company-auctex company-anaconda)))
